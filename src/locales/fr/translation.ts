...
export const TRANSLATION_FR = {
    ...
    cookies_policy: {
        ...
        text: 'Ce site Web utilise des cookies pour vous garantir la meilleure expérience sur notre site.',
    },
    country: 'Pays',
    ...
    pricing_tour_description: `<p>Consultez-nous en fonction de la saison et du nombre de voyageurs.</p>
                        <p>
                            Le circuit peut être adapté à vos intérêts, en modifiant également les points de départ et d'arrivée. Ne le manquez pas !
                        </p>`,
    price: 'Tarif',
    pricing_message:
    ...
    // S
    see_more: 'Voir plus',
    see_more_photos: 'Voir plus de photos',
    see_more_on_trip_advisor: 'Voir plus sur TripAdvisor',
    ...
    vita_morocco_goal:
        'Notre objectif est de fournir les meilleurs itinéraires avec une expérience réelle et authentique',
    // W
