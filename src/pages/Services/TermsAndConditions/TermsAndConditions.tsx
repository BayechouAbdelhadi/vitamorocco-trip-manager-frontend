...
const TERMS_AND_CONDITIONS = [
    ...
    },
    {
        ...
        "text": {
            "en": "<ul><li className='sub-li'>More than 15 days prior to the trip: deposit refund. However, your deposit can be held for a future trip with VITA MOROCCO on a date of your choice.</li><li className='sub-li'>Less than 48 hours to the trip start date: 100% charge of the total cost.</li></ul>",
            "fr": "<ul><li className='sub-li'>Plus de 15 jours avant le départ : remboursement du dépôt. Cependant, votre dépôt peut être conservé pour un futur voyage avec VITA MOROCCO à une date de votre choix.</li><li className='sub-li'>Moins de 48 heures avant la date de début du voyage : 100 % du coût total sera facturé.</li></ul>",
            "es": "<ul><li className='sub-li'>Más de 15 días antes del viaje: reembolso del depósito. Sin embargo, su depósito puede ser retenido para un viaje futuro con VITA MOROCCO en una fecha de su elección.</li><li className='sub-li'>Menos de 48 horas antes de la fecha de inicio del viaje: se cobrará el 100% del costo total.</li></ul>",
            "pt": "<ul><li className='sub-li'>Mais de 15 dias antes da viagem: reembolso do depósito. No entanto, seu depósito pode ser retido para uma viagem futura com VITA MOROCCO em uma data de sua escolha.</li><li className='sub-li'>Menos de 48 horas para a data de início da viagem: 100% do custo total será cobrado.</li></ul>",
            "ar": ""
        }
    },
    {
