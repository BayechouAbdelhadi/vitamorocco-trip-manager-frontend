...
const REVIEWS = [
    {
        avatar: '/img/trip_advisor_reviews/1.webp',
        pseudo: 'Caterina P',
    ...
    {
        avatar: '/img/trip_advisor_reviews/2.webp',
        pseudo: 'Serse M',
    ...
    {
        avatar: '/img/trip_advisor_reviews/3.webp',
        pseudo: 'David G',
    ...
    {
        avatar: '/img/trip_advisor_reviews/4.webp',
        pseudo: 'Sjoukje D',
